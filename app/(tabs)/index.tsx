...
export default function Index() {
  ...
  const topics = [
  { title: 'Overview', image: require('../../assets/images/app-logo.png'), routeTo: '/(modals)/overview' },
  { title: 'Data Structures', image: require('../../assets/images/ds_photo.png'), routeTo: '/(modals)/data_structure' },
  { title: 'Arrays', image: require('../../assets/images/array_photo.png'), routeTo: '/(modals)/arrays' },
  { title: 'Linked List', image: require('../../assets/images/linked_list_photo.png'), routeTo: '/(modals)/linked_list' },
  { title: 'Stacks', image: require('../../assets/images/stack_photo.png'), routeTo: '/(modals)/stacks' },
  { title: 'Pointers', image: require('../../assets/images/pointer_photo.png'), routeTo: '/(modals)/pointers_page' },
  { title: 'Queues', image: require('../../assets/images/queue_photo.png'), routeTo: '/(modals)/queues' },
